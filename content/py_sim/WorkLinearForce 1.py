...
# --- Inputs ---
x0 = 0 #float(input('Initial position (m) from 0 to 10'))        # Initial position (m)
v0 = 4 #float(input('Initial velocity (m/s) from -10 to 10'))        # Initial velocity (m/s)
k = 0.5 #float(input('Spring constant (N/m) from 0.1 to 1'))       # Spring constant (N/m)
m = 2.0        # Mass (kg)
